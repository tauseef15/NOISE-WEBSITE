...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function selectColor(itemColor) {
    localStorage.setItem("itemSelectedColor", itemColor);
  }
  ...
  function generateColorImages(itemVariable) {
    ...
    for (let slider of Object.values(item[itemVariable])) {
      ...
      if (slider && slider.image1) {
        // Append image HTML
        colorImagesHTML += `<div onclick='selectColor('${slider.slider}')'><img src="${slider.image1}" alt=""></div>`;
      }
    }
